...
remains open until the new Linux copy/move tests and CodeQL gate pass, and for
documenting the residual hostile local-parent rename semantics; those limitations
reinforce the private/VPN-only management boundary.
